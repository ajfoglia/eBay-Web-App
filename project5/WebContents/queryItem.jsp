...
<%
	...
	String itemNameURL = URLEncoder.encode(itemName, "UTF-8");
			...
			<div class="container">
				<div class="row-fluid vcenter">
					<div class="span6 offset1 center">
						...
						<% if(itemBuyPrice != "") { %>
							<form action="./pay" method="post" class="center">
								<input type="hidden" name ="itemId" value=<%=itemId%>>
								<input type="hidden" name ="itemName" value=<%=itemNameURL%>>
								<input type="hidden" name ="itemBuyPrice" value=<%=itemBuyPrice%>>
								<input type="submit" name="payButton" class="btn btn-success" value="Pay Now">
							</form>
						<% } %>
					</div>
