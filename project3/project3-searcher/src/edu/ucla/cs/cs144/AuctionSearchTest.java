...
public class AuctionSearchTest {
	public static void main(String[] args1)
	{
		...
		SearchResult[] basicResults = as.basicSearch(query, 1, 66);
		...
		SearchResult[] spatialResults = as.spatialSearch("camera", region, 0, 30);
